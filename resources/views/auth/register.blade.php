                ...
                <div class="register-card">
                    ...
                    <div class="register-card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right temporary-name">{{ __('E-Mail Address*') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right temporary-name">{{ __('Password*') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right temporary-name">{{ __('Confirm Password*') }}</label>
